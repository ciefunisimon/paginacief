          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 px-2 sm:px-0">
              ...
              >
                ...
                <p className="text-gray-700">
                 Nodos de articulación para el intercambio de conocimientos, fortalecimiento de capacidades investigativas y desarrollo de proyectos de impacto.
                </p>
              </Link>
            </div>
          </div>
